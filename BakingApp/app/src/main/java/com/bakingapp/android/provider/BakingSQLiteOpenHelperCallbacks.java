...
package com.bakingapp.android.provider;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;

import com.bakingapp.android.provider.base.BaseSQLiteOpenHelperCallbacks;

/**
 * Allows the app to be called when opening/creating/upgrading the db.
 */
public class BakingSQLiteOpenHelperCallbacks

    extends BaseSQLiteOpenHelperCallbacks {
    @Override
